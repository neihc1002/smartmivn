...
class WPO_Cache_Premium {
	...
	public function enqueue_scripts_styles() {
		...
		if ('post' == $current_screen->base) {
			...
			wp_localize_script('wp-optimize-cache-premium-admin', 'wp_optimize_ajax_nonce', wp_create_nonce('wp-optimize-ajax-nonce'));
		}
	}
	...
	public function wpo_page_only_scripts($min_or_not_internal, $min_or_not, $enqueue_version) {
		...
		wp_localize_script('wp-optimize-cache-premium', 'wp_optimize_ajax_nonce', wp_create_nonce('wp-optimize-ajax-nonce'));
	}
	...
	public function add_cache_control_metabox() {
		add_meta_box('wpo-cache-metabox', __('Page caching', 'wp-optimize'), array($this, 'render_cache_control_metabox'), get_post_types(array('public' => true)), 'side');
	}
